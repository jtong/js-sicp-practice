function filtered_accumulate(filter, combiner, null_value, term, a, next, b)
{
    ...
    return combiner(term(filter_current_and_next_a(filter, next, a)),filtered_accumulate(filter,combiner,null_value,term,next(filter_current_and_next_a(filter ,next , a)),next,b));
}
